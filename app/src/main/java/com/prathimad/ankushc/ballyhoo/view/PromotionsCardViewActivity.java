...
public class PromotionsCardViewActivity extends MenuNavigationActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.promo_action_settings) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.promo_nav_camera) {
            // Handle the camera action
        } else if (id == R.id.promo_nav_gallery) {

        } else if (id == R.id.promo_nav_slideshow) {

        } else if (id == R.id.promo_nav_manage) {

        } else if (id == R.id.promo_nav_share) {

        } else if (id == R.id.promo_nav_send) {
